...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  static const _pages = [
    _PageData(
      ...
      title: 'Scan a code.\nGet a row.\nExport a sheet.',
      subtitle:
          'Point your camera at any barcode or QR code. Each scan fills a row in your custom table. Export to CSV or Excel — free, offline, no account.',
      bullets: [
        _Bullet(
          Icons.qr_code_scanner_rounded,
          'Each scan = one row, instantly',
        ),
        _Bullet(Icons.table_rows_rounded, 'Export CSV/Excel free, no limits'),
    ...
    _PageData(
      ...
      title: 'Spreadsheet\nto codes\nin seconds.',
      subtitle:
          'Import any CSV or Excel file. Map two columns. Get a full grid of QR codes or barcodes — no internet required.',
      bullets: [
        _Bullet(Icons.file_present_rounded, 'Supports .csv and .xlsx'),
        _Bullet(Icons.bolt_rounded, 'Hundreds of codes in one tap'),
        _Bullet(Icons.wifi_off_rounded, 'Fully offline & private'),
      ],
    ),
    _PageData(
      icon: Icons.qr_code_2_rounded,
      gradient: [Color(0xFF1A7A3C), Color(0xFF30D158)],
      glowColor: Color(0x3330D158),
      tag: 'SINGLE CREATE',
      title: 'Your brand,\nyour code,\nyour style.',
      subtitle:
          'Generate one code at a time with custom colours, embedded logos, and label text below.',
      bullets: [
        _Bullet(Icons.palette_rounded, 'Custom colours & centre logo'),
        _Bullet(Icons.barcode_reader, 'QR, Code 128, EAN-13, UPC & more'),
        _Bullet(Icons.download_rounded, 'Save or share as image'),
      ],
    ),
    _PageData(
      icon: Icons.picture_as_pdf_rounded,
      gradient: [Color(0xFFB45309), Color(0xFFFF9F0A)],
      glowColor: Color(0x33FF9F0A),
      tag: 'PRINT READY',
      title: 'From phone\nto printer\nin one step.',
      subtitle:
          'Export your batch as a formatted A4 PDF label sheet — perfect column and row layout, ready to cut.',
      bullets: [
        _Bullet(Icons.grid_on_rounded, 'Custom rows & columns per page'),
        _Bullet(Icons.text_fields_rounded, 'Label text under each code'),
        _Bullet(Icons.share_rounded, 'Share or save PDF instantly'),
      ],
    ),
    _PageData(
      ...
      title: 'Scan once.\nAccess\nforever.',
      subtitle:
          'Scan any QR code or barcode with your camera. Every scan is stored locally and can be re-generated anytime.',
      bullets: [
        _Bullet(Icons.history_rounded, 'Full scan history, stored locally'),
        _Bullet(Icons.edit_rounded, 'Clone any scan into editor'),
